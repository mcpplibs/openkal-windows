...
//
// AND NOT `ProcessPrng`, WHICH WAS TRIED FIRST AND FAILS ON A WINDOWS HOST.
//
...
// one alike.
//
// THE FIRST DIAGNOSIS OF THIS WAS WRONG AND IS RECORDED SO IT IS NOT REPEATED:
...
//
// TWO SPELLINGS IN THE MANIFEST WERE TRIED BEFORE THIS AND BOTH WERE PUSHED,
...
int kal_random_fill(void* out, kal_uintptr len) {
    ...
    // NO LOOP. This call fills the whole buffer or fails; unlike a read it
